...
sendListButton: {
    async value(jid, text, list, footer, options = [], quoted = null) {
...
sendUrlImageButton: {
    async value(jid, text, row = [], footer, url, quoted = null) {
        let msg = generateWAMessageFromContent(jid, {
            viewOnceMessage: {
                message: {
                    "messageContextInfo": {
...
sendListImageButton: {
    async value(jid, text, list, footer, url, options = [], quoted = null) {
        let msg = generateWAMessageFromContent(jid, {
            viewOnceMessage: {
                message: {
                    "messageContextInfo": {
