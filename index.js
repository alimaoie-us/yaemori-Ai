...
const message = `${subtitleStyle('Developed by »')} ${responseStyle(author.name)}
${subtitleStyle('Under development »')} ${responseStyle('🇲🇦')}
${subtitleStyle('Active  »')} ${responseStyle(activeCollaborators)}
